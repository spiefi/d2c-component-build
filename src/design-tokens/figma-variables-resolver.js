// @ts-nocheck -- generated resolver supplied with the Figma variable export.

import variablesData from './Zgredek playground-variables-full.json';
import linearDiagramVariablesData from './linear-diagram-variables-full.json';

/** @typedef {import('./types.js').FigmaModes} FigmaModes */
/** @typedef {import('./types.js').ResolvedFigmaVariable} ResolvedFigmaVariable */
  
// 🔧 Configure the imports to include all the json files then add them to the allVariableData array 🔧
const allVariableData = [
  variablesData,
  linearDiagramVariablesData,
];
...
/**
 * @returns {Record<string, { modes: string[], defaultMode: string | undefined, id: string }>}
 */
...
/**
 * @param {FigmaModes} modesByCollectionName

...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A token-driven content card with an optional, content-sized React slot. Empty slots collapse completely; rendered slot children recursively inherit the Card modes.',
      },
    },
  },
  argTypes: {
